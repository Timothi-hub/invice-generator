...
const InvoicePreview = forwardRef<HTMLDivElement, InvoicePreviewProps>(
  ({ invoice, profile, showExpensesProfit = true, template = invoiceTemplates[0] }, ref) => {
    ...
    return (
      ...
      >
                  ...
                  <td className="py-3 px-4 text-foreground">
                    {item.width && item.height ? (
                      <span>
                        ...
                        {item.pieces && item.pieces > 1 && <span className="ml-1">× {item.pieces} pcs</span>}
        ...
        {/* Bottom Footer */}
        <div className="p-6 mt-8 relative" style={{ background: template.footerBg, color: template.footerText }}>
          <div className="flex justify-between items-end relative z-10">
            <div>
              <div className="border-t pt-2 mb-2 w-48" style={{ borderColor: `${template.footerText}80` }}>
