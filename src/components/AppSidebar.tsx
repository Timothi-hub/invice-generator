import { FileText, Users, BarChart3, Download, Upload, LogOut, Settings, History, Package, UserCog, Building2, Eye, AlertCircle, ShieldCheck, UserCircle } from 'lucide-react';
